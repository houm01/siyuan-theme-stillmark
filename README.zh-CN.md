...
- 外部链接显示源网站图标，离线或加载失败时使用中性兜底图标
- 以 CSS 为主，仅使用轻量站点图标辅助脚本，最低支持思源笔记 3.7.0

## 安装

主题通过社区集市审核后，可在“设置 → 集市 → 主题”中安装，再到“设置 → 外观 → 主题”选择 **Stillmark / 静痕**。

手动安装或本地开发时，克隆仓库并将它链接到思源主题目录：
